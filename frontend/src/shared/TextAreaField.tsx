...
const areaStyle = tv({
  base: "w-full resize-y rounded-md border border-border bg-surface px-3 py-2 font-mono text-xs text-foreground outline-none data-[focused]:border-brand-500 data-[focused]:ring-2 data-[focused]:ring-brand-500/30 data-[invalid]:border-destructive data-[disabled]:opacity-50",
});
